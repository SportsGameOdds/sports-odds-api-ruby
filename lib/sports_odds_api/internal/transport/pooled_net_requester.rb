      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - SportsOddsAPI::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = SportsOddsAPI::Internal::Util.uri_origin(url)
          timeout = deadline - SportsOddsAPI::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise SportsOddsAPI::Errors::APIConnectionError.new(url: url, request: req)
          end
