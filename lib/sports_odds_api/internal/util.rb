    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{SportsOddsAPI::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [SportsOddsAPI::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [SportsOddsAPI::Internal::Util::JSONL_CONTENT, Enumerable] unless SportsOddsAPI::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | SportsOddsAPI::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [SportsOddsAPI::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in SportsOddsAPI::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
