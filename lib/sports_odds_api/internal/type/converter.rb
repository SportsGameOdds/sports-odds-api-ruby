    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { SportsOddsAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { SportsOddsAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            SportsOddsAPI::FilePart.new(value)
          in SportsOddsAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in SportsOddsAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [SportsOddsAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: SportsOddsAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in SportsOddsAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in SportsOddsAPI::Internal::Type::Converter
              ...
              SportsOddsAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(SportsOddsAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end
