...
module SportsOddsAPI
  module Internal
    module Type
      ...
      # `SportsOddsAPI::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | SportsOddsAPI::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= SportsOddsAPI::Internal::Type::FileInput
        ...
        class << self
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, SportsOddsAPI::FilePart)
          end
        end
      end
    end
