...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/sports_odds_api/helpers/` and `examples/` directory.
...
require_relative "../lib/sports_odds_api"
...
```ruby
gem "sports-odds-api", git: "https://www.github.com/SportsGameOdds/sports-odds-api-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/SportsGameOdds/sports-odds-api-ruby' '<path-to-repo>'
```

```ruby
gem "sports-odds-api", path: "<path-to-repo>"
```
