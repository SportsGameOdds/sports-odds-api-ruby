...
class SportsOddsAPI::Test::SingletonClient < SportsOddsAPI::Client
  include Singleton
  ...
  def initialize
    super(
      base_url: SportsOddsAPI::Test::SingletonClient::TEST_API_BASE_URL,
...
class SportsOddsAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @sports_game_odds = SportsOddsAPI::Test::SingletonClient.instance
  end
