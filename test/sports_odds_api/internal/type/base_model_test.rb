...
class SportsOddsAPI::Test::PrimitiveModelTest < Minitest::Test
  A = SportsOddsAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = SportsOddsAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < SportsOddsAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      SportsOddsAPI::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => SportsOddsAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [SportsOddsAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [SportsOddsAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [SportsOddsAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        SportsOddsAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [SportsOddsAPI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [SportsOddsAPI::Internal::Type::Boolean, true] => true,
      [SportsOddsAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => SportsOddsAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        SportsOddsAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = SportsOddsAPI::Internal::Type::Converter.new_coerce_state
      SportsOddsAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        SportsOddsAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class SportsOddsAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include SportsOddsAPI::Internal::Type::Enum
...
class SportsOddsAPI::Test::CollectionModelTest < Minitest::Test
  A1 = SportsOddsAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = SportsOddsAPI::Internal::Type::HashOf[Integer]

  A2 = SportsOddsAPI::Internal::Type::ArrayOf[H1]
  H2 = SportsOddsAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = SportsOddsAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = SportsOddsAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class SportsOddsAPI::Test::BaseModelTest < Minitest::Test
  class M1 < SportsOddsAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < SportsOddsAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < SportsOddsAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, SportsOddsAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = SportsOddsAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = SportsOddsAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(SportsOddsAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue SportsOddsAPI::Errors::ConversionError => e
...
class SportsOddsAPI::Test::UnionTest < Minitest::Test
  class U0
    include SportsOddsAPI::Internal::Type::Union
  ...
  class M2 < SportsOddsAPI::Internal::Type::BaseModel
  ...
  class M4 < SportsOddsAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, SportsOddsAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < SportsOddsAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, SportsOddsAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class SportsOddsAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include SportsOddsAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [SportsOddsAPI::Internal::Type::Unknown, SportsOddsAPI::Internal::Type::Unknown] => true,
      [SportsOddsAPI::Internal::Type::Boolean, SportsOddsAPI::Internal::Type::Boolean] => true,
      [SportsOddsAPI::Internal::Type::Unknown, SportsOddsAPI::Internal::Type::Boolean] => false,
...
class SportsOddsAPI::Test::MetaInfoTest < Minitest::Test
  A1 = SportsOddsAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = SportsOddsAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
