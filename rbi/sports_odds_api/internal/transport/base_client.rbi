      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    SportsOddsAPI::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              request:
                SportsOddsAPI::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status: T.any(Integer, SportsOddsAPI::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(SportsOddsAPI::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req:
                SportsOddsAPI::Internal::Transport::BaseClient::RequestComponents,
              opts: SportsOddsAPI::Internal::AnyHash
            )
            .returns(
              SportsOddsAPI::Internal::Transport::BaseClient::RequestInput
            )
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: SportsOddsAPI::Internal::Type::Unknown,
          options: {}
        )
        end
